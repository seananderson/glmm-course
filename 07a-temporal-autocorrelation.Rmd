...
Let's fit a basic mixed-effects model predicting dive depth from surface temperature that allows the intercept and sloped to vary with each fish. We are going to center the temperature predictor first to reduce correlation between the intercepts and slopes.
...
```{r}
source("drafts/predict_pop_ci.R") # from <https://rpubs.com/bbolker/glmmchapter>
