...
Answer: a unit increase in `x` corresponds to a `r round(coef(m_bin)[[2]], 1)` increase in the log odds of a `1` being observed.

What does that mean? If we exponentiate the slope coefficient we get the expected fold increase in the *odds* of observing a `1`, `r round(exp(coef(m_bin)[[2]]),1)`.
