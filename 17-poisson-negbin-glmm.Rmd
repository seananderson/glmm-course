...
Let's quickly look at some plots we can get out of the sjPlot package. Remember, these confidence intervals shouldn't be trusted because we haven't dealt with overdispersion yet.
...
```{r, eval=FALSE}
p <- sjPlot::sjp.glmer(m_glmer, type = "eff", show.ci = TRUE)
head(p$data)
```
