...
What is `y ~ x^2` actually mean in simplified form?
...
A group of grad students are trying to model log(frog density) as a function of soil characteristics. What might their model look like in the following cases (using lmer)? Give cases with random intercepts only and cases with random intercepts and slopes.
