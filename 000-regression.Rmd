...
Fit a linear regression predicting log life expectancy from log GDP per capita with our new data set `life`. Why might it make sense to work with logs here?
