...
good initial starting values for a range value and nugget effect. For the
`nlme::corSpher()` correlation structure, the nugget represents the intercept
value and the range represents the distance at which the semivariogram reaches
1.
