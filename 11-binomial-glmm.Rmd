...
[O'Regan et al. 2013](http://doi.org/10.1890/13-0916.1). These data represent
time to metamorphosis for 3 amphibian species in a mesocosm experiment. The
experiment had 2 levels of warming (normal and accelerated) and 2 levels of
pond drying (normal/permanent and accelerated/temporary). There were multiple
tanks per treatment condition.
...
m_list <- lmList(meta ~ week_centered | tank, data = d, 
...
(Hint: remember the divide by 4 rule.)
...
This looks substantially better, although not perfect. It's possible that
